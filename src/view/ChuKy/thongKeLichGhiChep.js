    ...
    >
      <View style={styles.item}>
        <View style={styles.Item_DS_ChuKy}>
          ...
          <Text style={styles.view_TieuDe_nghieng}>
            Tiền cho ăn: {parseFloat(item.tienDoAn).toLocaleString('en-US')} VND
          </Text>
        </View>
        <View style={styles.Item_DS_ChuKy}>
          <View>
        ...
        <View style={styles.progressBarContainer}>
          <View style={{ ...styles.progressBar, width: `${(item.tienDoAn / maxTienChoAn) * 100}%` }}>
            <Text style={styles.progressText}>
              {(item.tienDoAn / maxTienChoAn * 100).toFixed(2)}%
            </Text>
          </View>
        </View>
      </View>
