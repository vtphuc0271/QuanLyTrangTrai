...
export default function SuaGhiChepChuKyChanNuoi({ route, navigation }) {
  ...
  const handleDelete = async () => {
      try {
          const response = await fetch('http://192.168.24.1/API_QuanLyNongTrai/ChuKy/delDataLichGhiChep.php', {
    ...
    const handleEdit = async () => {
        try {
            const response = await fetch('http://192.168.24.1/API_QuanLyNongTrai/ChuKy/editDataLichGhiChep.php', {
